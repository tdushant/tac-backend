...
<!-- NAV ITEM - NOTICES -->
    ...
    <!-- NAV ITEM - Custom Clients -->
    @if (in_array('custom-clients', user_modules()))
        <x-menu-item icon="graph-up" :text="__('app.menu.custom-clients')"> 
            ...
            <div class="accordionItemContent pb-2">   
                <x-sub-menu-item :link="route('sales-report.index')"
                                        :text="__('app.menu.custom-clients')" />
            </div>
        </x-menu-item>
    @endif
